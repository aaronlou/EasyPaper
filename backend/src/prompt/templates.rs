...
【输出 JSON 格式】
{
  ...
  "translation": {
    ...
    "sections": [
      {
        "heading": "章节名",
        "original_excerpt": "精选英文原文摘录，保留最能体现专业表达的2-5句，不要整段照搬过长内容",
        "translated_text": "该章节的中文翻译/忠实摘要，保留关键术语英文",
        "expression_notes": [
...
- inspiration 给 4-6 条，必须聚焦“能迁移的研究/写作/工程启发”
- structure_logic 给 5-8 步，分析论文结构和论证逻辑是否值得学习
- prerequisites 给 5-8 个，每个至少给 1 条资料线索；资料可以来自检索摘要、参考文献线索或合理 inferred query
- research_directions 给 5-8 条，覆盖方法改进、实验补充、应用扩展、理论问题、复现验证
- literature_review 给 4-7 个阶段，形成思想发展脉络
- lineage.builds_on 和 follow_ups 各给 3-6 条；如果没有可靠后续研究，就给 search_queries 并说明不确定
- translation.sections 不要逐字翻译整篇；按 Abstract/Introduction/Method/Experiments/Conclusion 等生成章节级中文忠实翻译摘要，每节 120-250 字
- translation.sections 必须保留必要英文对照：original_excerpt 选 2-5 句最值得学习的英文原文或专业表达片段，避免过长摘录
- translation.sections.expression_notes 每节给 2-4 条，解释英文专业表达如何对应中文、为什么这样写更像论文语言
- translation.glossary 给 8-15 个核心术语或高频学术表达，term 保留英文，translation 给中文，note 说明译法和使用语境
