...
export default function ConceptDeepDiveModal({ conceptId, onClose }: Props) {
  ...
  return (
    ...
    >
      <div
        className="relative grid max-h-[92vh] w-full max-w-6xl overflow-hidden rounded-2xl bg-white shadow-2xl lg:grid-cols-[340px_minmax(0,1fr)]"
        onClick={(e) => e.stopPropagation()}
      >
        <aside className="flex min-h-0 flex-col border-b border-slate-200 bg-slate-950 p-5 text-white lg:border-b-0 lg:border-r">
